...
save('./Data/Argo_data_aggr.mat','startYear','endYear','nProf','profLatAggr','profLongAggr','profYearAggr','profMonthAggr','profJulDayAggr','profFloatIDAggr','profCycleNumberAggr','profModeAggr','profPresAggr','profTempAggr','profPsalAggr','profTransSysAggr','-v7.3');
